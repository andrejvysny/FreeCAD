...
/// Integer spinbox with scroll guard to prevent accidental value changes
/// when the widget is inside a scrollable panel.
class FCComponentLibExport FcSpinBox : public QSpinBox
{
    Q_OBJECT
    Q_PROPERTY(bool scrollGuard READ scrollGuard WRITE setScrollGuard)

public:
    explicit FcSpinBox(QWidget* parent = nullptr);
